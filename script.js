...
class User {
  ...
  validate() {
    ...
    // if (new Date(this.date) >= tenYears || date === '') {
    //   errors.push({
...
//   alert("Реєстрація успішно!");
// });
//! warning
// const registerBtn = document.getElementById("submit_btn");
...
// for deleting users email

// singInBtn.addEventListener("click", deleteCurrentUserEmail);
// function deleteCurrentUserEmail() {
//   const email = document.getElementById("emailSingIn").value;
//   const currentUserEmail = localStorage.getItem(email);
//   localStorage.removeItem(currentUserEmail);
// }

// export { deleteCurrentUserEmail }